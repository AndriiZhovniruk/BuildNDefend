...
public class ResourceGenerator : MonoBehaviour
{
    ...
    public static int GetNearblyResourceAmount(ResourceGeneratorData resourceGeneratorData, Vector3 position)
    {
    ...
    private void Start()
    {
        int nearbyResourceAmount = GetNearblyResourceAmount(resourceGeneratorData, transform.position);
        if (nearbyResourceAmount == 0)
        {
            //нема ресурсів в області
            enabled = false;
            timerMax = 0.0f;
        }
        else
